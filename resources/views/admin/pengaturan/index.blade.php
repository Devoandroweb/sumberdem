                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="image-live" data-target="favicon" data-ext="ico,png">
                            ...
                            <img id="favicon" src="{{asset('image/setting/'.$data->favicon)}}" style="width: 100px; height:100px" class="rounded-circle shadow mb-4 img-fluid" alt="" srcset="">
                            @else
                            <img id="favicon" src="{{asset('assets/dist/img/default-150x150.png')}}"  style="width: 100px; height:100px" class="rounded-circle shadow mb-4 img-fluid" alt="" srcset="">
                            @endif
                        </div>
                        <div class="text-danger mb-4"><small><i>File Tidak Boleh Lebih besar dari 1Mb</i></small></div>
                    </div>
